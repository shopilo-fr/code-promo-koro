#!/usr/bin/env python3
"""
Recuperation des codes promo KoRo depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/koro.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/koro.fr"
STORE_NAME = "KoRo"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour KoRo depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-koro)"
    }
    try:
